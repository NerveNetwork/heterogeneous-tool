...
import static network.nerve.heterogeneous.BSCTool.BNB_GAS_LIMIT_OF_BNB;
import static network.nerve.heterogeneous.constant.BnbConstant.ZERO_ADDRESS;
...
public class BNBWalletApi implements WalletApi {
    ...
    public String sendTransaction(String toAddress, String fromAddress, String secretKey, BigDecimal amount) {
        ...
        try {
            result = sendBNB(fromAddress, secretKey, toAddress, amount, BNB_GAS_LIMIT_OF_BNB, BSCTool.getBscGasPrice());
        } catch (Exception e) {
