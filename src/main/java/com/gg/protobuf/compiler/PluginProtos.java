...
package com.gg.protobuf.compiler;
...
public final class PluginProtos {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PluginProtos.internal_static_google_protobuf_compiler_Version_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PluginProtos.Version.class, PluginProtos.Version.Builder.class);
    }
    ...
    public static PluginProtos.Version parseFrom(
    ...
    public static PluginProtos.Version parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static PluginProtos.Version parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PluginProtos.Version parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PluginProtos.Version prototype) {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(PluginProtos.Version other) {
        if (other == PluginProtos.Version.getDefaultInstance()) return this;
        if (other.hasMajor()) {
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (PluginProtos.Version) e.getUnfinishedMessage();
  ...
  public interface CodeGeneratorRequestOrBuilder extends
     ...
     * <code>repeated .google.protobuf.FileDescriptorProto proto_file = 15;</code>
     */
    DescriptorProtos.FileDescriptorProtoOrBuilder getProtoFileOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              ...
              compilerVersion_ = input.readMessage(PluginProtos.Version.PARSER, extensionRegistry);
              if (subBuilder != null) {
            ...
            case 122: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                protoFile_ = new java.util.ArrayList<DescriptorProtos.FileDescriptorProto>();
                mutable_bitField0_ |= 0x00000004;
              }
              protoFile_.add(
                  input.readMessage(DescriptorProtos.FileDescriptorProto.PARSER, extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PluginProtos.internal_static_google_protobuf_compiler_CodeGeneratorRequest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PluginProtos.CodeGeneratorRequest.class, PluginProtos.CodeGeneratorRequest.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends DescriptorProtos.FileDescriptorProtoOrBuilder>
        getProtoFileOrBuilderList() {
      return protoFile_;
    }
    /**
     ...
     */
    @java.lang.Override
    public DescriptorProtos.FileDescriptorProtoOrBuilder getProtoFileOrBuilder(
        int index) {
      return protoFile_.get(index);
    }
    ...
    public PluginProtos.Version getCompilerVersion() {
      return compilerVersion_ == null ? PluginProtos.Version.getDefaultInstance() : compilerVersion_;
    }
    /**
     * <pre>
     * The version number of protocol compiler.
    ...
    public static PluginProtos.CodeGeneratorRequest parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static PluginProtos.CodeGeneratorRequest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static PluginProtos.CodeGeneratorRequest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PluginProtos.CodeGeneratorRequest prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(PluginProtos.CodeGeneratorRequest other) {
        if (other == PluginProtos.CodeGeneratorRequest.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (PluginProtos.CodeGeneratorRequest) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000002;
      ...
      private void ensureProtoFileIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          protoFile_ = new java.util.ArrayList<DescriptorProtos.FileDescriptorProto>(protoFile_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
              DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> protoFileBuilder_;
      ...
      public Builder setProtoFile(
          int index, DescriptorProtos.FileDescriptorProto value) {
        if (protoFileBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setProtoFile(
          int index, DescriptorProtos.FileDescriptorProto.Builder builderForValue) {
        if (protoFileBuilder_ == null) {
          ensureProtoFileIsMutable();
      ...
      public Builder addAllProtoFile(
          java.lang.Iterable<? extends DescriptorProtos.FileDescriptorProto> values) {
        if (protoFileBuilder_ == null) {
          ensureProtoFileIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, protoFile_);
       ...
       * <code>repeated .google.protobuf.FileDescriptorProto proto_file = 15;</code>
       */
      public DescriptorProtos.FileDescriptorProto.Builder getProtoFileBuilder(
          int index) {
      ...
      public DescriptorProtos.FileDescriptorProto.Builder addProtoFileBuilder(
          int index) {
        return getProtoFileFieldBuilder().addBuilder(
            index, DescriptorProtos.FileDescriptorProto.getDefaultInstance());
      }
      /**
       * <pre>
       * FileDescriptorProtos for all files in files_to_generate and everything
       ...
       * <code>repeated .google.protobuf.FileDescriptorProto proto_file = 15;</code>
       */
      public java.util.List<DescriptorProtos.FileDescriptorProto.Builder>
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          PluginProtos.Version, PluginProtos.Version.Builder, PluginProtos.VersionOrBuilder> compilerVersionBuilder_;
      /**
       * <pre>
       * The version number of protocol compiler.
       * </pre>
      ...
      public Builder setCompilerVersion(
          PluginProtos.Version.Builder builderForValue) {
        if (compilerVersionBuilder_ == null) {
      ...
      public Builder mergeCompilerVersion(PluginProtos.Version value) {
        if (compilerVersionBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
              compilerVersion_ != null &&
              compilerVersion_ != PluginProtos.Version.getDefaultInstance()) {
            compilerVersion_ =
              PluginProtos.Version.newBuilder(compilerVersion_).mergeFrom(value).buildPartial();
          } else {
            compilerVersion_ = value;
          }
          onChanged();
      ...
      public PluginProtos.VersionOrBuilder getCompilerVersionOrBuilder() {
        if (compilerVersionBuilder_ != null) {
          ...
          return compilerVersion_ == null ?
              PluginProtos.Version.getDefaultInstance() : compilerVersion_;
        }
      }
      /**
       * <pre>
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          PluginProtos.Version, PluginProtos.Version.Builder, PluginProtos.VersionOrBuilder>
          getCompilerVersionFieldBuilder() {
        if (compilerVersionBuilder_ == null) {
  ...
  public interface CodeGeneratorResponseOrBuilder extends
     ...
     * <code>repeated .google.protobuf.compiler.CodeGeneratorResponse.File file = 15;</code>
     */
    PluginProtos.CodeGeneratorResponse.FileOrBuilder getFileOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 122: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                file_ = new java.util.ArrayList<PluginProtos.CodeGeneratorResponse.File>();
                mutable_bitField0_ |= 0x00000004;
              }
              file_.add(
                  input.readMessage(PluginProtos.CodeGeneratorResponse.File.PARSER, extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return PluginProtos.internal_static_google_protobuf_compiler_CodeGeneratorResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              PluginProtos.CodeGeneratorResponse.class, PluginProtos.CodeGeneratorResponse.Builder.class);
    }
    ...
    private static final long serialVersionUID = 0L;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 130: {
                ...
                generatedCodeInfo_ = input.readMessage(DescriptorProtos.GeneratedCodeInfo.PARSER, extensionRegistry);
                if (subBuilder != null) {
      ...
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        ...
        return PluginProtos.internal_static_google_protobuf_compiler_CodeGeneratorResponse_File_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                PluginProtos.CodeGeneratorResponse.File.class, PluginProtos.CodeGeneratorResponse.File.Builder.class);
      }
      ...
      public DescriptorProtos.GeneratedCodeInfo getGeneratedCodeInfo() {
        return generatedCodeInfo_ == null ? DescriptorProtos.GeneratedCodeInfo.getDefaultInstance() : generatedCodeInfo_;
      }
      /**
       * <pre>
       * Information describing the file content being inserted. If an insertion
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof PluginProtos.CodeGeneratorResponse.File)) {
          return super.equals(obj);
        }
      ...
      public static PluginProtos.CodeGeneratorResponse.File parseFrom(
          java.nio.ByteBuffer data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static PluginProtos.CodeGeneratorResponse.File parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseWithIOException(PARSER, input);
      }
      ...
      public static PluginProtos.CodeGeneratorResponse.File parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static PluginProtos.CodeGeneratorResponse.File parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(PluginProtos.CodeGeneratorResponse.File prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
      }
      @java.lang.Override
      public Builder toBuilder() {
      ...
      public static final class Builder extends
        ...
        public Builder mergeFrom(PluginProtos.CodeGeneratorResponse.File other) {
          if (other == PluginProtos.CodeGeneratorResponse.File.getDefaultInstance()) return this;
          if (other.hasName()) {
            bitField0_ |= 0x00000001;
            name_ = other.name_;
            onChanged();
        ...
        public Builder mergeFrom(
          ...
          try {
            ...
            parsedMessage = (PluginProtos.CodeGeneratorResponse.File) e.getUnfinishedMessage();
            throw e.unwrapIOException();
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000004;
        ...
        private DescriptorProtos.GeneratedCodeInfo generatedCodeInfo_;
        private com.google.protobuf.SingleFieldBuilderV3<
                DescriptorProtos.GeneratedCodeInfo, DescriptorProtos.GeneratedCodeInfo.Builder, DescriptorProtos.GeneratedCodeInfoOrBuilder> generatedCodeInfoBuilder_;
        /**
         * <pre>
         * Information describing the file content being inserted. If an insertion
         * point is used, this information will be appropriately offset and inserted
        ...
        public Builder setGeneratedCodeInfo(
            DescriptorProtos.GeneratedCodeInfo.Builder builderForValue) {
          if (generatedCodeInfoBuilder_ == null) {
        ...
        public Builder mergeGeneratedCodeInfo(DescriptorProtos.GeneratedCodeInfo value) {
          if (generatedCodeInfoBuilder_ == null) {
            if (((bitField0_ & 0x00000008) != 0) &&
                generatedCodeInfo_ != null &&
                generatedCodeInfo_ != DescriptorProtos.GeneratedCodeInfo.getDefaultInstance()) {
              generatedCodeInfo_ =
                DescriptorProtos.GeneratedCodeInfo.newBuilder(generatedCodeInfo_).mergeFrom(value).buildPartial();
            } else {
              generatedCodeInfo_ = value;
            }
            onChanged();
        ...
        public DescriptorProtos.GeneratedCodeInfoOrBuilder getGeneratedCodeInfoOrBuilder() {
          if (generatedCodeInfoBuilder_ != null) {
            ...
            return generatedCodeInfo_ == null ?
                DescriptorProtos.GeneratedCodeInfo.getDefaultInstance() : generatedCodeInfo_;
          }
        }
        /**
         * <pre>
         ...
         */
        private com.google.protobuf.SingleFieldBuilderV3<
                DescriptorProtos.GeneratedCodeInfo, DescriptorProtos.GeneratedCodeInfo.Builder, DescriptorProtos.GeneratedCodeInfoOrBuilder>
            getGeneratedCodeInfoFieldBuilder() {
          if (generatedCodeInfoBuilder_ == null) {
      ...
      static {
        DEFAULT_INSTANCE = new PluginProtos.CodeGeneratorResponse.File();
      }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends PluginProtos.CodeGeneratorResponse.FileOrBuilder>
        getFileOrBuilderList() {
      return file_;
    }
    /**
     ...
     */
    @java.lang.Override
    public PluginProtos.CodeGeneratorResponse.FileOrBuilder getFileOrBuilder(
        int index) {
      return file_.get(index);
    }
    ...
    public static PluginProtos.CodeGeneratorResponse parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static PluginProtos.CodeGeneratorResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static PluginProtos.CodeGeneratorResponse parseFrom(
    ...
    public static PluginProtos.CodeGeneratorResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static PluginProtos.CodeGeneratorResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static PluginProtos.CodeGeneratorResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(PluginProtos.CodeGeneratorResponse prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(PluginProtos.CodeGeneratorResponse other) {
        if (other == PluginProtos.CodeGeneratorResponse.getDefaultInstance()) return this;
        if (other.hasError()) {
          bitField0_ |= 0x00000001;
          error_ = other.error_;
          onChanged();
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage = (PluginProtos.CodeGeneratorResponse) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000001;
      ...
      private void ensureFileIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          file_ = new java.util.ArrayList<PluginProtos.CodeGeneratorResponse.File>(file_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          PluginProtos.CodeGeneratorResponse.File, PluginProtos.CodeGeneratorResponse.File.Builder, PluginProtos.CodeGeneratorResponse.FileOrBuilder> fileBuilder_;
      ...
      public Builder setFile(
          int index, PluginProtos.CodeGeneratorResponse.File value) {
        if (fileBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setFile(
          int index, PluginProtos.CodeGeneratorResponse.File.Builder builderForValue) {
        if (fileBuilder_ == null) {
          ensureFileIsMutable();
      ...
      public Builder addAllFile(
          java.lang.Iterable<? extends PluginProtos.CodeGeneratorResponse.File> values) {
        if (fileBuilder_ == null) {
          ensureFileIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, file_);
       ...
       * <code>repeated .google.protobuf.compiler.CodeGeneratorResponse.File file = 15;</code>
       */
      public PluginProtos.CodeGeneratorResponse.File.Builder getFileBuilder(
          int index) {
      ...
      public PluginProtos.CodeGeneratorResponse.File.Builder addFileBuilder(
          int index) {
        return getFileFieldBuilder().addBuilder(
            index, PluginProtos.CodeGeneratorResponse.File.getDefaultInstance());
      }
      /**
       * <code>repeated .google.protobuf.compiler.CodeGeneratorResponse.File file = 15;</code>
       */
      public java.util.List<PluginProtos.CodeGeneratorResponse.File.Builder>
           getFileBuilderList() {
        return getFileFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          PluginProtos.CodeGeneratorResponse.File, PluginProtos.CodeGeneratorResponse.File.Builder, PluginProtos.CodeGeneratorResponse.FileOrBuilder>
          getFileFieldBuilder() {
        if (fileBuilder_ == null) {
