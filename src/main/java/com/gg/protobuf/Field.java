...
private static final long serialVersionUID = 0L;
   ...
   * @return The kind.
   */
  @java.lang.Override public Field.Kind getKind() {
    @SuppressWarnings("deprecation")
    Field.Kind result = Field.Kind.valueOf(kind_);
   ...
   */
  @java.lang.Override public Field.Cardinality getCardinality() {
    @SuppressWarnings("deprecation")
    Field.Cardinality result = Field.Cardinality.valueOf(cardinality_);
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (kind_ != Field.Kind.TYPE_UNKNOWN.getNumber()) {
      output.writeEnum(1, kind_);
    }
    if (cardinality_ != Field.Cardinality.CARDINALITY_UNKNOWN.getNumber()) {
