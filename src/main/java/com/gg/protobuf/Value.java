...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            if (kindCase_ == 5) {
              subBuilder = ((Struct) kind_).toBuilder();
            }
            kind_ =
                input.readMessage(Struct.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((Struct) kind_);
          ...
          case 50: {
            ...
            if (kindCase_ == 6) {
              subBuilder = ((ListValue) kind_).toBuilder();
            }
            kind_ =
                input.readMessage(ListValue.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((ListValue) kind_);
              kind_ = subBuilder.buildPartial();
            }
            kindCase_ = 6;
            break;
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:google.protobuf.Value)
          com.gg.protobuf.ValueOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return StructProto.internal_static_google_protobuf_Value_descriptor;
    }
