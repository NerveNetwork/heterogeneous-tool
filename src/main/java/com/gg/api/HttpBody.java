...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              extensions_ = new java.util.ArrayList<Any>();
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return HttpBodyProto.internal_static_google_api_HttpBody_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            HttpBody.class, HttpBody.Builder.class);
  }
  ...
  private java.util.List<Any> extensions_;
  /**
   * <pre>
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureExtensionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        extensions_ = new java.util.ArrayList<Any>(extensions_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
            Any, Any.Builder, AnyOrBuilder> extensionsBuilder_;
