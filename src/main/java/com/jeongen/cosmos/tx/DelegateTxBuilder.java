...
public class DelegateTxBuilder {
     ...
     */
    public static TxOuterClass.Tx createDelegateTxRequest(CosmosRestApiClient apiClient, CosmosCredentials payerCredentials, SendInfo sendInfo, BigDecimal feeInAtom, long gasLimit) throws Exception {
        ...
        //创建质押信息
        Tx.MsgDelegate.Builder msgBuilder = Tx.MsgDelegate.newBuilder();
